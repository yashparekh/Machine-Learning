# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 16:58:52 2018
...
y_pred=grd.predict(X_test) #predicts class
y_pred_prob=grd.predict_proba(X_test) [:,1] # [:,1]-calculates probability of class 1(survived)
# =============================================================================
