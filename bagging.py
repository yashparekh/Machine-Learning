...
bagging_model=BaggingRegressor(base_estimator=tree_model, n_estimators=100) #will have 100 outputs and final output is the average of the prev 100 outputs
